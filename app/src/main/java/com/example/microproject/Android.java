...
public class Android extends AppCompatActivity {
    ...
    private AndroidQuestion androidQuestion  = new AndroidQuestion();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.android_questions);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(option1.isChecked() || option2.isChecked() || option3.isChecked() || option4.isChecked()) {
                    ...
                    Toast.makeText(Android.this, "You have not Selected any Choice \n Please!! Select your Answer", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void checkLastQuestion(){
        if(total_question_no == androidQuestion.lengthOfQuestions()) {
            ...
            next.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(Android.this, "That was the Last Question!!", Toast.LENGTH_SHORT).show();
                    goBackToLanguage();
                }
            });
