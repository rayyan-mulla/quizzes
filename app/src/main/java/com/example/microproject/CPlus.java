...
public class CPlus extends AppCompatActivity {
    ...
    private CPlusQuestion androidQuestion  = new CPlusQuestion();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cplus_questions);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(option1.isChecked() || option2.isChecked() || option3.isChecked() || option4.isChecked()) {
                    ...
                    Toast.makeText(CPlus.this, "You have not Selected any Choice \n Please!! Select your Answer", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void checkLastQuestion(){
        if(total_question_no == androidQuestion.lengthOfQuestions()) {
            ...
            next.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(CPlus.this, "That was the Last Question!!", Toast.LENGTH_SHORT).show();
                    goBackToLanguage();
                }
            });
